...
- App Store actions use Apple's official localized SVG badge; menu and FAQ icons remain inline SVG. The primary pages ship no icon font and no executable JavaScript.
