...
export const commercialDisclosureDocuments: Localized<LegalDocument> = {
  ja: {
    ...
    sections: [
      ...
      { heading: "販売価格", paragraphs: ["日本での現在価格（税込）は、月額500円、年額1,500円、買い切り4,000円です。対象となる月額・年額プランには7日間の無料トライアルが付きます。購入確定前にApp Storeの購入手続き画面に表示される価格が適用されます。日本以外では、各国・地域のApp Storeに表示される価格が適用されます。"] },
