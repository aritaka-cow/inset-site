...
export const commercialDisclosureDocuments: Localized<LegalDocument> = {
  ja: {
    ...
    sections: [
      ...
      { heading: "販売価格", paragraphs: ["月額・年額の自動更新サブスクリプション、または買い切りを提供しています。実際に適用される価格は、購入確定前にApp Storeの購入手続き画面へ各国・地域の通貨で表示されます。対象となる月額・年額プランには7日間の無料トライアルが付き、トライアル終了後は同じ購入手続き画面に表示された価格で課金されます。"] },
  ...
  en: {
    ...
    sections: [
      ...
      { heading: "Price", paragraphs: ["Monthly and yearly auto-renewable subscriptions and a Lifetime purchase are available. The applicable price is shown in the App Store purchase screen in the currency for the customer's country or region before confirmation. Eligible monthly and yearly subscriptions include a 7-day free trial, after which the price shown in that purchase screen is charged."] },
